...
import { BuildingManagerAdd } from 'queries/building_mutations'
...
const BuildingManager = ({ query, history }) => {
	...
	if (!query.data.buildings || !query.data.buildings.length) return <Page />

	const building = query.data.buildings[0]
					...
					<FormComponent>
						<form onSubmit={submit}>
							<div className="pb-form-title">
								<span>ENTER NEW MANAGER DETAILS</span>
							</div>
